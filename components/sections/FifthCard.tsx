    ...
    <div className="flex flex-col lg:flex-row justify-center items-center gap-6 mt-20 max-sm:mt-10  max-md:mt-10 max-lg:mt-10 lg:gap-6  w-full max-w-[1100px] mx-auto  ">
      <div className="flex justify-center  items-center lg:mt-0  mt-6 md:max-w-[538px] w-full px-6  ">
        <div className="flex flex-col max-w-[430px] md:max-w-[536px] ">
          ...
          Save your tarot reading results and share them with friends or family to get their input or to compare readings.
          </p>
          <ul
            role="list"
          ...
          >
            ...
            <li className="text-[#25224a] text-[18px] font-semibold">Keep track of your readings and see how they change over time</li>
            </div>
          </ul>
          <div>
          <Button className="rounded-lg bg-[#7557fa] text-white mt-10 py-8 px-14 max-sm:px-6  max-md:px-8 text-[18px]">
            Save and Share My Reading
          </Button>
          </div>
        </div>
      </div>
