...
const FirstCard = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center gap-6 mt-20 lg:gap-6  w-full max-w-[1100px] mx-auto  ">
      <div className="flex justify-center  items-center lg:mt-0  mt-6 md:max-w-[538px] w-full px-6  ">
        <div className="flex flex-col max-w-[430px] md:max-w-[536px] ">
          <h4 className="text-[36px] font-bold text-[#312f3a] leading-[50px] mb-6 max-md:text-[32px] max-sm:text-[28px] max-sm:leading-10 max-md:leading-10 max-w-[450px]">
            Get Personalized Tarot Readings Online
          </h4>
          <p className="text-[18px] mt-2 text-[#676b78] leading-[28.8px] mb-4 max-md:text-[18px] max-sm:leading-6 max-md:leading-6 max-sm:text-[16px] max-w-[503px]">
            Our online tarot service uses AI to give you a personalized reading
            that is unique to your question.
          </p>
          <ul
            role="list"
          ...
          >
            ...
            <li className="text-[#25224a] text-[18px] font-semibold">Tailored to your specific question or concern</li>
            </div>
            <div className="flex gap-2">
            <CgShapeCircle className="mt-2 text-[20px] text-[#3e50f7] font-bold"/> <li className="text-[#25224a] text-[18px] font-semibold">Accessible from anywhere with an internet connection</li>
            </div>
            <div className="flex gap-2 items-center">
            <CgShapeCircle className="mt-1 text-[20px] text-[#3e50f7] font-bold"/> <li className="text-[#25224a] text-[18px] font-semibold">Quick and easy process for fast answers</li>
            </div>
          </ul>
          <div>
